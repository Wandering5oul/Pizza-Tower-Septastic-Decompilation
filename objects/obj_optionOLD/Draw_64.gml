...
_os_rs = optionsaved_resolution;
draw_text_colour(480, 180, "RESOLUTION", c_white, c_white, c_white, c_white, (_os == 1) ? 1 : 0.5);
draw_text_colour(300, 230, "480X270", c_white, c_white, c_white, c_white, (_os_rs == 0) ? 1 : 0.5);
draw_text_colour(480, 230, "960X540", c_white, c_white, c_white, c_white, (_os_rs == 1) ? 1 : 0.5);
draw_text_colour(680, 230, "1920X1080", c_white, c_white, c_white, c_white, (_os_rs == 2) ? 1 : 0.5);
