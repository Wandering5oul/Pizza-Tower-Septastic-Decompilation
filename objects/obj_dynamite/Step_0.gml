...
if (obj_explosion != 66 && playerid.key_shoot2 && playerid.state != UnknownEnum.Value_2)
{
    instance_destroy();
...
if (place_meeting(x + hsp, y + vsp, obj_destructibles) || place_meeting(x + hsp, y + vsp, obj_metalblock) || place_meeting(x, y, obj_baddie))
{
    instance_destroy();
    instance_create(x, y, obj_explosion);
}
