...
for (i = 0; i < array_length(monster_pos); i++)
{
    bpos = monster_pos[i];
...
function robot_create_gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1)
{
    var _inst, _dir, _hinst, _doorInst;
    
    if (!instance_exists(obj_robotmonster))
    {
        _inst = instance_create(x, y, obj_robotmonster);
        _dir = monster_dir[0];
...
function blob_create_gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1)
{
    var _inst, _dir, _hinst, _doorInst, i;
...
function puppet_create_gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1)
{
    instance_create_unique(0, 0, 678);
}

function hillbilly_create_gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1)
{
    var _inst, _dir, _hinst, _doorInst;
...
function grid_meeting_gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1)
{
...
function grid_length_x_gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1, argument2)
{
    var count;
...
function room_place_gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1)
{
    if (argument0 < 0 || argument0 > (map_width - 1) || argument1 < 0 || argument1 > (map_height - 1))
        return -4;
