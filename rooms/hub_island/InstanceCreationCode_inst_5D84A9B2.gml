...
pm_scene_info = [[cutscene_do_dialog, [dialog_create("Here you go")]], [cutscene_waitfor_dialog], [cutscene_set_player_actor], [cutscene_set_object_pos, 112635, 1696, 576], [cutscene_do_dialog, [dialog_create("Go ahead", -4, function()
{
})]]];
