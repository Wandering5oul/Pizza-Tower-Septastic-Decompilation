if (global.levelcomplete && !global.kidspartycutscene)
{
    currentroom = room;
    mechactor = -4;
    scene_info = [[cutscene_entrance_start], [cutscene_waitfor_sprite, 243], [cutscene_player_idleanim], [cutscene_change_room, 127], [cutscene_set_player_visible, 0], [cutscene_set_player_pos, 1848, 750], [cutscene_player_float, 1], [cutscene_wait, 50], [function()
    {
