if (global.levelcomplete && !global.desertcutscene)
{
    ...
    scene_info = [[cutscene_entrance_start], [cutscene_waitfor_sprite, 243], [cutscene_player_idleanim], [cutscene_change_room, 211], [cutscene_set_player_visible, 0], [cutscene_set_player_pos, 1152, 384], [cutscene_wait, 100], [cutscene_entrance_middle], [cutscene_wait, 100], [cutscene_change_room, currentroom], [cutscene_set_player_visible, 1], [cutscene_desert_end], [cutscene_save_game]];
}
