...
if (global.levelcomplete && !global.dungeoncutscene)
{
    ...
    currentroom = room;
    scene_info = [[cutscene_entrance_start], [cutscene_waitfor_sprite, 243], [cutscene_player_idleanim], [cutscene_change_room, 662], [cutscene_set_player_visible, 0], [cutscene_player_float, 1], [cutscene_set_player_pos, 1696, 1600], [cutscene_wait, 40], [cutscene_dungeon_middle], [cutscene_wait, 200], [cutscene_change_room, currentroom], [cutscene_player_float, 0], [cutscene_set_player_visible, 1], [cutscene_dungeon_end], [cutscene_save_game]];
}
