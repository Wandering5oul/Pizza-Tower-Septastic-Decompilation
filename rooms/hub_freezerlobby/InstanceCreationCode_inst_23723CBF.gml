if (global.levelcomplete && !global.freezercutscene)
{
    ...
    currentroom = room;
    dragonactor = 114140;
    scene_info = [[cutscene_medieval_start], [cutscene_waitfor_sprite, 243], [function()
    {
        with (obj_actor)
        {
    ...
    }], [cutscene_change_room, 171], [cutscene_set_player_visible, 0], [cutscene_set_player_pos, 1407, 415], [cutscene_wait, 20], [function()
    {
    ...
    }], [cutscene_soundeffect, 15], [cutscene_camera_shake, 5, 3 / room_speed], [function()
    {
        with (dragonactor)
        {
    ...
    }], [cutscene_wait, 50], [function()
    {
        ...
        cutscene_end_action();
    }], [cutscene_wait, 50], [cutscene_change_room, 162], [cutscene_set_player_visible, 0], [cutscene_set_player_pos, 190, 600], [cutscene_soundeffect, 15], [cutscene_camera_shake, 5, 3 / room_speed], [cutscene_wait, 50], [function()
    {
        with (obj_freezerblock)
            instance_destroy();
