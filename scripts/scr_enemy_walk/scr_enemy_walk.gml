function scr_enemy_walk()
{
    ...
    if (!grounded && object_index != obj_clownmato && object_index != obj_noisey && object_index != obj_ancho && object_index != obj_miniufo && object_index != obj_kentukybomber && object_index != obj_clownmato)
    {
