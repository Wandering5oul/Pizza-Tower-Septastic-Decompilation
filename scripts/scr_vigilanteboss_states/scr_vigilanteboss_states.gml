...
function vigilante_decide_attack_phase1()
{
    ...
    else
    {
        targetstunned = 0;
        attack_cooldown = attack_max[phase - 1];
        state = choose(UnknownEnum.Value_103, UnknownEnum.Value_1, UnknownEnum.Value_92, UnknownEnum.Value_92);
...
function boss_vigilante_revolver()
{
    ...
    if (phase > 4)
        vigilante_cancel_attack(UnknownEnum.Value_2, 128);
}
...
function boss_vigilante_mach1()
{
    ...
    if (phase > 4)
        vigilante_cancel_attack(!honor ? UnknownEnum.Value_1 : 42, 128);
}
...
function boss_vigilante_crouchslide()
{
    ...
    if (phase > 4)
        vigilante_cancel_attack(164, 128, 82);
}
...
function boss_vigilante_punch()
{
    ...
    if (phase > 4)
        vigilante_cancel_attack(164, 82);
}
...
function boss_vigilante_freefallland()
{
    ...
    if (phase > 4)
        vigilante_cancel_attack(!honor ? UnknownEnum.Value_1 : 42, 82);
}
...
function boss_vigilante_superattack()
{
    ...
    with (lastplayerid)
    {
        if (state != 160 && state != UnknownEnum.Value_137 && state != UnknownEnum.Value_156 && state != UnknownEnum.Value_61)
        {
            state = 160;
            x = room_width / 3;
        }
