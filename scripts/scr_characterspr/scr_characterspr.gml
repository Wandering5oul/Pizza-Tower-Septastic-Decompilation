function scr_characterspr()
{
    if (character == "P" && ispeppino)
    {
        ...
        spr_mach2jump = spr_player_longjump;
        ...
        spr_chainsawclimbwall = spr_player_chainsawclimbwall;
        spr_chainsawdashstart = spr_player_chainsawdashstart;
        spr_chainsawdash = spr_player_chainsawdash;
        spr_chainsawhitwall = spr_player_chainsawhitwall;
        spr_chainsawhit = spr_player_chainsawhit;
        spr_chainsawcrouch = spr_player_chainsawcrouch;
        spr_chainsawfireass = spr_player_chainsawfireass;
