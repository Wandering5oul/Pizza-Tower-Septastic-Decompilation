function scr_player_grabbed()
{
    ...
    _obj_player = (object_index == obj_player2) ? 245 : 244;
    ...
    if (_obj_player.state == UnknownEnum.Value_121 && fightball == 1)
    {
        x = _obj_player.x;
        y = _obj_player.y;
    }
    ...
    with (_obj_player)
    {
        ...
        if (!(state == UnknownEnum.Value_79 || (state == UnknownEnum.Value_121 && fightball == 1) || state == UnknownEnum.Value_191 || state == UnknownEnum.Value_193 || state == UnknownEnum.Value_192 || state == UnknownEnum.Value_194 || state == UnknownEnum.Value_6 || state == UnknownEnum.Value_55 || state == UnknownEnum.Value_74 || state == UnknownEnum.Value_75 || state == UnknownEnum.Value_20 || state == UnknownEnum.Value_80 || state == UnknownEnum.Value_76 || state == UnknownEnum.Value_81 || state == UnknownEnum.Value_82 || state == UnknownEnum.Value_83))
        {
            baddiegrabbedID = 449;
